...
const tick = () =>
{
    ...
    ghost1.position.x = Math.cos(ghost1Angle) * (4 + Math.sin(elapsedTime * .29))
    ghost1.position.z = Math.sin(ghost1Angle) * (4 + Math.cos(elapsedTime * .29))
    ghost1.position.y = Math.sin(elapsedTime * 3) + Math.tan(elapsedTime * .2)
    
    const ghost2Angle = - elapsedTime * .32
    ghost2.position.x = Math.cos(ghost2Angle) * (5.2 + Math.tan(elapsedTime * .22))
    ghost2.position.z = Math.sin(ghost2Angle) * (5.2 + Math.cos(elapsedTime * .22))
    ghost2.position.y = Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 2.5)
    
    const ghost3Angle = - elapsedTime * .16
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * .32))
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.tan(elapsedTime * .32))
